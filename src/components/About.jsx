...
function About() {
  return (
    <>
      ...
      <p>I started coding from HTML, CSS,  jQuery and WordPress at Manabito.co in 2020.
        Through learning jQuery, I was eager to learn from fundamental to a wide range of JavaScript. 
        Then I decided to move into Europe and joined Ironhack Fullstack Web Development Bootcamp in 2021.</p>
